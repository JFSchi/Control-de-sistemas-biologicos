...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4179056907U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(717259658U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2286788835U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1218930232U);
}
...
mxArray *sf_c2_sistemaUno_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("fiNGQyQkw4FZ5OCTzemMKH");
...
static void mdlSetWorkWidths_c2_sistemaUno(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3567618333U));
  ssSetChecksum1(S,(3384964374U));
  ssSetChecksum2(S,(2503201290U));
  ssSetChecksum3(S,(1587303116U));
